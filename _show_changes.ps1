...
$inc = @('index.html', 'css/', 'js/', 'config/', 'assets/', 'docs/', 'mail_agent.ps1', 'install_agent.bat', 'uninstall_agent.bat', 'start_agent.bat', 'send_mail.ps1', 'send.bat', 'override.json.example', 'dept_manager.json.example', 'autoimport.json.example')
